			...
			<nav class="navbar navbar-default">
				...
				<div class="navbar-header">
				  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					...
					<div class="logo">
						<h1><a class="navbar-brand" href="index.html"><span>D</span>igital <i class="fa fa-plus" aria-hidden="true"></i> <p>Notice Board</p></a></h1>
					</div>
				</div>
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					...
					<ul id="m_nav_list" class="m_nav menu__list">
						...
						<li class="m_nav_item menu__item" id="moble_nav_item_5"> <a href="display/" class="menu__link">Notice Board</a> </li>
				...
				<li>
					<div class="w3layouts-banner-top">
							...
							<div class="container">
									...
									<span>Digital NB</span>
									<h3>Informative Environment </h3>
									 <p>Creates an informative atmosphere among all the stakeholders of the system</p>
						...
						<div class="container">
								<div class="agileits-banner-info">
								 <span>External Stakeholders</span>
									<h3>Outsiders </h3>
									 <p>Brings them near to the system</p>
						...
						<div class="w3layouts-banner-top w3layouts-banner-top2">
							<div class="container">
								<div class="agileits-banner-info">
									...
									<h3>Creates transperancy </h3>
									 <p>Develops confidence among all the stakeholders about the organization</p>
...
<!-- about -->
	<div class="about" id="about">
		<div class="container">
			<h2 class="w3_heade_tittle_agile">Welcome to our Project Work</h2>
			<p class="sub_t_agileits">Digital Notice Board</p>
			
			<p class="ab">Developed by: Ruchitha S | Sandhya K | Priyanka G N | Rashmi S P<br>
			Project Guided by: Prof. Veerendra K Y</p>
			 ...
			 <div class="about-w3lsrow"> 
				...
				<div class="col-md-6 col-sm-7 w3about-img two"> 
					<div class="w3about-text"> 
						<h5 class="w3l-subtitle">Aim or Objectives of the project</h5>





<p>•	Establish eco-friendly environment by which to Save the trees and paper</p>
<p>•	Establish strong communication environment to ensure the transparency of the system.</p>
<p>•	Alert the system about on-going scenarios of the organization.
</p>
...
<!-- icons -->
	<div class="banner-bottom" id="about">
		<div class="container">
					<h2 class="w3_heade_tittle_agile">ADMIN / HOD / FACULTY / COORDINATOR LOGIN</h2>
			        <p class="sub_t_agileits">LOGIN TO CREATE NEWS</p>
