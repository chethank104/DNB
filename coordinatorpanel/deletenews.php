...
{
$aid = $_POST['usertype'];
$query11 = "delete FROM news_tab WHERE nid=$aid";
$result11 = mysqli_query($con,$query11) or die(mysqli_error());

echo "Successfully deleted the news";	
}
else
{

echo "<h2>DELETE NEWS </H2>					
<form action='deletenews.php' method='post'>
<label>SELECT NEWS TO DELETE:
<SELECT name='usertype'>";

$query11 = "SELECT * FROM news_tab WHERE typenews<>3";
$result11 = mysqli_query($con,$query11) or die(mysqli_error());
while ($row11 = mysqli_fetch_assoc($result11))
{
echo "<option value='$row11[nid]'>$row11[nnews]</option>";
}

echo "</select><BR><BR><BR>
<input type='submit' value='DELETE NEWS' name='usertoupdate'>
</form>";
}
