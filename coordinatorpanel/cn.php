...
$sql = "INSERT INTO news_tab (nnews, datetodisplay, datetilldisplay, dateuploaded, typenews) VALUES ('$tnews', '$fdate', '$tdate', '$dateupload', 2)";

if (mysqli_query($con, $sql)) {
    $msg = "Horizontal news created successfully...";
} 
	   ...
	   <div class="inner-content">
		<!-- header-starts -->
			...
			<div class="content">
				...
				<div>
					<label>ENTER HORIZONTAL TEXT NEWS:<br> 
					<h3>
					<?php
					echo $msg;
					?>
						...
						<input placeholder="To date:" type="date" tabindex="1" required="" autofocus="" name="tdate">
									...
									<div>
					<input type="submit" value="CREATE HORIZONTAL TEXT NEWS">
				</div>
				</div>
			</form>
